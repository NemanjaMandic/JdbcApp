...
public class AddressBookDisplay extends JFrame {
    ...
    public AddressBookDisplay() {
        ...
        previousButton.setText("<<< Prevoius");
        previousButton.setEnabled(false);
        previousButton.addActionListener((ActionEvent e) -> {
            previousButtonActionPerformed(e);
        });
        navigatePanel.add(previousButton);
        navigatePanel.add(Box.createVerticalStrut(10));

        indexTextField.setHorizontalAlignment(JTextField.CENTER);
        indexTextField.addActionListener((ActionEvent e) -> {
    ...
    private void previousButtonActionPerformed(ActionEvent ev){
        ...
        indexTextFieldActionPerformed(ev);
    }
    private void nextButtonActionPerformed(ActionEvent ev){
        currentEntryIndex++;
    ...
    private void queryButtonActionPerformed(ActionEvent ev){
        ...
        if(numberOfEntries != 0){
            ...
            browseButtonActionPerformed(ev);
    }
    private void indexTextFieldActionPerformed(ActionEvent ev){
    ...
    private void browseButtonActionPerformed(ActionEvent ev){
        try{
    ...
    private void insertButtonActionPerformed(ActionEvent ev){
